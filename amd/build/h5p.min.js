define(["jquery","core/ajax","core/notification"],function($,ajax,notification){return{init:function(contextid){var botao;if(document.getElementById("page-contentbank")){botao=`
                    ...
                    </a>`;$("#page-contentbank .content-bank-container .cb-toolbar-container").prepend(botao)}if(document.getElementById("page-mod-h5pactivity-mod")){botao=`
                    <div>
                    ...
                    </div>`;$("#id_error_contentbank").before(botao)}if(document.getElementById("page-mod-scorm-mod")){botao=`
                    <div>
                    ...
                    </div>`;$("#id_packagefile_fieldset").before(botao)}}}});