...
/**
 * Class h5pactivity_extractor
 */
class h5pactivity_extractor extends generic_extractor {
    /**
    ...
    public function extract(cm_info $cm, stdClass $course, $userid) {
        ...
        if ($h5p) {
            $content->intro = content_cleaner::clean_html($h5p->intro);
            $content->metadata["packagefileid"] = $h5p->packagefile ?? "";
            $content->maincontent =
