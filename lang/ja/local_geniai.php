...
$string['analysis_excluded_plugins'] = '活動分析から除外するモジュール';
$string['analysis_excluded_plugins_desc'] = '選択したモジュールには分析ボタンが表示されず、コース分析からも除外されます。';
...
$string['analysis_not_supported'] = 'この活動タイプは GeniAI による分析に対応していません。';
