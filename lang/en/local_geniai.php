...
$string['privacy:metadata'] = 'The GeniAI plugin stores the history of the conversations you send and will transmit to OpenAI only the full name, course name, and URL, without sharing any other personal data of yours.';
