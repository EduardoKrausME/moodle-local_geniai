...
$string['privacy:metadata'] = 'El plugin GeniAl almacena el historial de las conversaciones que envías y transmitirá a OpenAI solo el nombre del curso y la URL, sin compartir ningún dato personal tuyo.';
